...
import app.luzzy.R
import app.luzzy.activities.ConversationDetailsActivity
...
fun Activity.launchViewIntent(uri: Uri, mimetype: String, filename: String) {
    if (mimetype.startsWith("video/", ignoreCase = true)) {
        Intent(this, app.luzzy.activities.VideoPlayerActivity::class.java).apply {
            putExtra(app.luzzy.activities.VideoPlayerActivity.EXTRA_VIDEO_URI, uri)
            putExtra(app.luzzy.activities.VideoPlayerActivity.EXTRA_VIDEO_TITLE, filename)
