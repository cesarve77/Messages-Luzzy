...
import app.luzzy.adapters.ContactsAdapter
import app.luzzy.databinding.ActivityConversationDetailsBinding
...
class ConversationDetailsActivity : SimpleActivity() {
    ...
    private fun updateBackgroundColors() {
        ...
        binding.apply {
            arrayOf(
                ...
                customNotificationsHolder, autoResponseHolder, blockButton
            ).forEach {
    ...
    private fun setupAutoResponseMode() = binding.apply {
        val textColor = getProperTextColor()
